// src/app/api/teacher/tuition/bookings/[publicId]/cancel/route.ts
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ publicId: string }> }) {
  ...
  const res = await djangoFetch(`/private-tuition/bookings/${publicId}/cancel/`, { method: "POST", body: JSON.stringify(body) });
