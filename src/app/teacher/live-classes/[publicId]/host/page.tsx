...
import { Mic, MicOff, Video as VideoIcon, VideoOff, PhoneOff, Megaphone, MonitorUp, Monitor } from "lucide-react";
...
export default function LiveClassHostPage({ params }: { params: Promise<{ publicId: string }> }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 flex flex-col z-50">
      ...
      <div className="flex items-center justify-center gap-3 py-6 flex-wrap px-4">
        ...
        <button onClick={toggleScreenShare} className={`p-3.5 rounded-full text-white ${isSharingScreen ? "bg-emerald-600" : "bg-slate-800 hover:bg-slate-700"}`}>
